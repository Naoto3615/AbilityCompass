...
軽度知的障害を持つ大人が就労（農業・製造・清掃等）に向けて  
「どう成長すれば働けるようになるか」を可視化・サポートする Django アプリです。

Python 3.12 / Django 4.2 / Tailwind CSS で構成されています。

## 主な機能

- **特性診断**: 6特性（集中力・コミュニケーション力・体力・正確性・感情コントロール・学習意欲）を測定し向いている仕事タイプを提案
- **成長ロードマップ**: 3ステップ（生活習慣 → 作業スキル → 就労準備）で就労への道筋を提示
- **日々の記録**: きもちスタンプ・体調・できたこと/むずかしかったことを記録
- **支援者ダッシュボード**: 家族・支援員が利用者の進捗確認・メモ記録・AIアドバイス閲覧
